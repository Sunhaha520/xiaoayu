...
if (pathName === '/') {
  $(document).ready(function(){
      if ( $("#bber-talk").length > 0 ) {
        var jsonUrl = ''
        jsonUrl = "https://6262-bber-0gk6bsyyeb566235-1304618499.tcb.qcloud.la/json/bber.json"
        $.getJSON(jsonUrl+"?t="+Date.parse( new Date()),function(res){
          ...
          $.each(res.data, function(i, item){
            ...
            bberHtml += '<li class="item item-'+(i+1)+'">'+'<a href="https://www.lovechina.gq/ayubibi/" style="color: var(--font-color);/*font-weight: normal;*/">'+newdataTime+'： '+urlToLink(item.content)+'</a></li>'
          });
